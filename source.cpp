...
void ascendingSwap(int index1, int index2, int *ar)                                           //swap the two values such that they appear in ascending order in the array
{
...
int main()                                                                                        //main driver function
{
	...
	int n; int y;
	cout << "enter the number of elements to be sorted ( should be in the order of 2^n)";     //try to fix this issue 
	cin >> n;
	int *ar = new int[n];
	for (int i = 0; i<n; i++)
	{
	...
	cout << "the values after a bitonic sort \n";
	cout << "-------------------------------- \n";
